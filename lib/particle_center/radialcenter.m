...
% last modified June 10, 2012 (minor change: remove plotting option)
%
...
%% Deleted: code for plotting the gradients, for illustration purposes.  Moved to 'illustrate_gradient.m' 
